...
- 애널리스트들은 FY2026 동안 NVIDIA의 매출이 1,740억 달러에서 1,860억 달러 사이가 될 것으로 예상하며, AI 솔루션에 대한 지속적인 강한 수요가 있을 것입니다.
...
- Blackwell GPU: Upcoming GPU platform expected to generate significant revenue and support various system configurations.
- AI accelerators: Specialized hardware designed to accelerate AI workloads.
- ASICs: Application-specific integrated circuits tailored for specific tasks, posing competition to GPUs.
